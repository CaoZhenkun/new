...
public class Rinex {
    ...
    public void writeBody(PositioningData epochMeasurement)
    {
        ...
        if(ver==Constants.VER_3_03)
        {
            ...
            开始一个历元的卫星数据
             */
            for (GpsSatellite gpsSatellite : epochMeasurement.gpsSatelliteList) {
            ...
            for (QzssSatellite qzssSatellite : epochMeasurement.qzssSatelliteList) {
            ...
            for (BdsSatellite bdsSatellite : epochMeasurement.bdsSatelliteList) {

                if (bdsSatellite.isHasC1() && bdsSatellite.isHasC5()&& bdsSatellite.isHasC2I()) {
                    stringBuilder.append(String.format("%s%14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f", bdsSatellite.getPrn(), bdsSatellite.getC1(), bdsSatellite.getL1(), bdsSatellite.getD1(), bdsSatellite.getS1(), bdsSatellite.getC5(), bdsSatellite.getL5(), bdsSatellite.getD5(), bdsSatellite.getS5(),bdsSatellite.getC2I(),bdsSatellite.getL2I(),bdsSatellite.getD2I(),bdsSatellite.getS2I()));

                    stringBuilder.append('\n');
                }
                if (bdsSatellite.isHasC1() && !bdsSatellite.isHasC5() && !bdsSatellite.isHasC2I()) {
                    stringBuilder.append(String.format("%s%14.3f  %14.3f  %14.3f  %14.3f", bdsSatellite.getPrn(), bdsSatellite.getC1(), bdsSatellite.getL1(), bdsSatellite.getD1(), bdsSatellite.getS1()));

                    stringBuilder.append('\n');
                }
                if (!bdsSatellite.isHasC1() && bdsSatellite.isHasC5() && !bdsSatellite.isHasC2I()) {
                    stringBuilder.append(String.format("%s%14s  %14s  %14s  %14s  %14.3f  %14.3f  %14.3f  %14.3f", bdsSatellite.getPrn(), " ", " ", " ", " ", bdsSatellite.getC5(), bdsSatellite.getL5(), bdsSatellite.getD5(), bdsSatellite.getS5()));

                    stringBuilder.append('\n');
                }
                if (!bdsSatellite.isHasC1() && !bdsSatellite.isHasC5() && bdsSatellite.isHasC2I()) {
                    stringBuilder.append(String.format("%s%14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14.3f  %14.3f  %14.3f  %14.3f", bdsSatellite.getPrn(), " ", " ", " ", " ",  " ", " ", " ", " ",bdsSatellite.getC2I(), bdsSatellite.getL2I(), bdsSatellite.getD2I(), bdsSatellite.getS2I()));

                    stringBuilder.append('\n');
                }
                if (bdsSatellite.isHasC1() && bdsSatellite.isHasC5()&& !bdsSatellite.isHasC2I()) {
                    stringBuilder.append(String.format("%s%14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f", bdsSatellite.getPrn(), bdsSatellite.getC1(), bdsSatellite.getL1(), bdsSatellite.getD1(), bdsSatellite.getS1(), bdsSatellite.getC5(), bdsSatellite.getL5(), bdsSatellite.getD5(), bdsSatellite.getS5()));

                    stringBuilder.append('\n');
                }
                if (bdsSatellite.isHasC1() && !bdsSatellite.isHasC5()&& bdsSatellite.isHasC2I()) {
                    stringBuilder.append(String.format("%s%14.3f  %14.3f  %14.3f  %14.3f  %14s  %14s  %14s  %14s  %14.3f  %14.3f  %14.3f  %14.3f", bdsSatellite.getPrn(), bdsSatellite.getC1(), bdsSatellite.getL1(), bdsSatellite.getD1(), bdsSatellite.getS1(),  " ", " ", " ", " ",bdsSatellite.getC2I(),bdsSatellite.getL2I(),bdsSatellite.getD2I(),bdsSatellite.getS2I()));

                    stringBuilder.append('\n');
                }
                if (!bdsSatellite.isHasC1() && bdsSatellite.isHasC5()&& bdsSatellite.isHasC2I()) {
                    stringBuilder.append(String.format("%s%14s %14s  %14s %14s  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f  %14.3f", bdsSatellite.getPrn(), " ", " ", " ", " ", bdsSatellite.getC5(), bdsSatellite.getL5(), bdsSatellite.getD5(), bdsSatellite.getS5(),bdsSatellite.getC2I(),bdsSatellite.getL2I(),bdsSatellite.getD2I(),bdsSatellite.getS2I()));
            ...
            for (GalileoSatellite galileoSatellite : epochMeasurement.galileoSatelliteList) {
            ...
            for (GlonassSatellite glonassSatellite : epochMeasurement.glonassSatelliteList) {
